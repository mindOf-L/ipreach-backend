...
public class IPreachBackendApplication {

    private static IPreachBackendApplication Instance;
    private final ContextConstants contextConstants;

    @PostConstruct
    public void init() {
        IPreachBackendApplication.Instance = this;
    }

    public static void main(String[] args) throws UnknownHostException {
        var _ = SpringApplication.run(IPreachBackendApplication.class, args);
